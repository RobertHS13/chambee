...
public class SWEliminarTrabajoPublicacion extends ServicioWebEscritura {
    public SWEliminarTrabajoPublicacion(Context context, Response.Listener<String> listener, Response.ErrorListener errorListener) {
