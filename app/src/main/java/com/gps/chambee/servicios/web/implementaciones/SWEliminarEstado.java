...
public class SWEliminarEstado extends ServicioWebEscritura {
    public SWEliminarEstado(Context context, Response.Listener<String> listener, Response.ErrorListener errorListener) {
