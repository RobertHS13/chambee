...
public class SWEliminarCiudad extends ServicioWebEscritura {
    public SWEliminarCiudad(Context context, Response.Listener<String> listener, Response.ErrorListener errorListener) {
