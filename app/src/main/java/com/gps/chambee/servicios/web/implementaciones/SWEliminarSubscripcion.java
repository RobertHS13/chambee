...
public class SWEliminarSubscripcion extends ServicioWebEscritura {
    public SWEliminarSubscripcion(Context context, Response.Listener<String> listener, Response.ErrorListener errorListener) {
