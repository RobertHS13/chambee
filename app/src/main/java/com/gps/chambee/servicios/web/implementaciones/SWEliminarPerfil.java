...
public class SWEliminarPerfil extends ServicioWebEscritura {
    public SWEliminarPerfil(Context context, Response.Listener<String> listener, Response.ErrorListener errorListener) {
