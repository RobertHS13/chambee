...
public class SWEliminarPerfilUsuario extends ServicioWebEscritura {
    public SWEliminarPerfilUsuario(Context context, Response.Listener<String> listener, Response.ErrorListener errorListener) {
