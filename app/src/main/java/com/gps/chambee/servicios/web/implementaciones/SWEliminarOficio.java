...
public class SWEliminarOficio extends ServicioWebEscritura {
    public SWEliminarOficio(Context context, Response.Listener<String> listener, Response.ErrorListener errorListener) {
