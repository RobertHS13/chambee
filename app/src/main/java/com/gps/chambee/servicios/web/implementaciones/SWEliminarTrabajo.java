...
public class SWEliminarTrabajo extends ServicioWebEscritura {
    public SWEliminarTrabajo(Context context, Response.Listener<String> listener, Response.ErrorListener errorListener) {
