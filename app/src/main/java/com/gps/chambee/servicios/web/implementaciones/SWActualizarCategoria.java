...
public class SWActualizarCategoria extends ServicioWebEscritura {
    public SWActualizarCategoria(Context context, Response.Listener<String> listener, Response.ErrorListener errorListener) {
