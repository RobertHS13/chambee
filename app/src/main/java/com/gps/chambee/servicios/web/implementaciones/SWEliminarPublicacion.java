...
public class SWEliminarPublicacion extends ServicioWebEscritura {
    public SWEliminarPublicacion(Context context, Response.Listener<String> listener, Response.ErrorListener errorListener) {
