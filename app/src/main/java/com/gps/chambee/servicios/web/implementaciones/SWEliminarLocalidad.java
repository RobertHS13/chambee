...
public class SWEliminarLocalidad extends ServicioWebEscritura {
    public SWEliminarLocalidad(Context context, Response.Listener<String> listener, Response.ErrorListener errorListener) {
