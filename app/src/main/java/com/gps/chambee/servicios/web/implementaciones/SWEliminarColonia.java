...
public class SWEliminarColonia extends ServicioWebEscritura {
    public SWEliminarColonia(Context context, Response.Listener<String> listener, Response.ErrorListener errorListener) {
