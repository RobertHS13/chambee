...
public class SWActualizarPublicacion extends ServicioWebEscritura {
    public SWActualizarPublicacion(Context context, Response.Listener<String> listener, Response.ErrorListener errorListener) {
    ...
    protected Map<String, String> definirParams(Object... args) {
        ...
        Publicacion publicacion = (Publicacion) args[1];
    ...
    protected String definirUrl(Object... args) {
        return "chabee.online/escritura/serviceweb_cambio_publicaciones.php";
    }
