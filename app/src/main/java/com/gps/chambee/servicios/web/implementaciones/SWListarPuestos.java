...
public class SWListarPuestos extends ServicioWebLectura {
    public SWListarPuestos(Context context, Response.Listener<JSONObject> responseListener, Response.ErrorListener errorListener) {
