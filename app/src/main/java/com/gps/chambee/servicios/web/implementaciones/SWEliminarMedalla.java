...
public class SWEliminarMedalla extends ServicioWebEscritura {
    public SWEliminarMedalla(Context context, Response.Listener<String> listener, Response.ErrorListener errorListener) {
