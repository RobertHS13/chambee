...
public class SWEliminarPublicacionPostulados extends ServicioWebEscritura {
    public SWEliminarPublicacionPostulados(Context context, Response.Listener<String> listener, Response.ErrorListener errorListener) {
