...
public class SWEliminarMedallaPerfil extends ServicioWebEscritura {
    public SWEliminarMedallaPerfil(Context context, Response.Listener<String> listener, Response.ErrorListener errorListener) {
