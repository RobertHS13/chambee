...
public class SWEliminarComentarioPublicacion extends ServicioWebEscritura {
    public SWEliminarComentarioPublicacion(Context context, Response.Listener<String> listener, Response.ErrorListener errorListener) {
