...
public class SWEliminarCategoria extends ServicioWebEscritura {
    public SWEliminarCategoria(Context context, Response.Listener<String> listener, Response.ErrorListener errorListener) {
