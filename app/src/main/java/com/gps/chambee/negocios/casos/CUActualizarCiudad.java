...
import com.gps.chambee.servicios.web.implementaciones.SWActualizarCiudad;

public class CUActualizarCiudad extends CasoUso<String>{

    public CUActualizarCiudad(Context context, EventoPeticionAceptada<String> eventoPeticionAceptada, EventoPeticionRechazada eventoPeticionRechazada) {
