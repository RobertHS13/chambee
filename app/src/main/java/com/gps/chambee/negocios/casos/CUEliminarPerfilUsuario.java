...
public class CUEliminarPerfilUsuario extends CasoUso<String>{

    public CUEliminarPerfilUsuario(Context context, EventoPeticionAceptada<String> eventoPeticionAceptada, EventoPeticionRechazada eventoPeticionRechazada) {
        super(context, eventoPeticionAceptada, eventoPeticionRechazada);
    }

    @Override
    protected ServicioWeb definirServicioWeb() {
        return new SWEliminarPerfilUsuario(context, new Response.Listener<String>() {
            @Override
